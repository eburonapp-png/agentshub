...
const executeCodeTool: FunctionDeclaration = {
  name: 'execute_code',
  description: 'Execute code or scripts in a secure sandbox environment.',
  parameters: {
    type: Type.OBJECT,
    properties: {
      language: { type: Type.STRING, enum: ['python', 'javascript', 'bash'] },
...
const githubActionTool: FunctionDeclaration = {
  name: 'github_action',
  description: 'Trigger a GitHub Action workflow, create a PR, or manage repositories.',
  parameters: {
    type: Type.OBJECT,
    properties: {
      action: { type: Type.STRING, enum: ['trigger_workflow', 'create_pr', 'merge_pr'] },
...
const searchWebTool: FunctionDeclaration = {
  name: 'search_web',
  description: 'Search the web for up-to-date information, documentation, or market research.',
  parameters: {
    type: Type.OBJECT,
    properties: {
...
const sendEmailTool: FunctionDeclaration = {
  name: 'send_email',
  description: 'Send an email or notification to stakeholders or team members.',
  parameters: {
    type: Type.OBJECT,
    properties: {
      to: { type: Type.STRING },
...
const createTicketTool: FunctionDeclaration = {
  name: 'create_ticket',
  description: 'Create a Jira or Linear ticket for task tracking.',
  parameters: {
    type: Type.OBJECT,
    properties: {
      title: { type: Type.STRING },
...
const analyzeDataTool: FunctionDeclaration = {
  name: 'analyze_data',
  description: 'Run data analysis on business metrics or system logs.',
  parameters: {
    type: Type.OBJECT,
    properties: {
...
export const AGENTS: Record<AgentId, Agent> = {
  zeus: {
    ...
    voice: 'Zephyr',
    tone: 'Authoritative',
    tools: [updateTodoListTool, searchWebTool, analyzeDataTool]
  },
  aquiles: {
    id: 'aquiles',
    name: 'Aquiles',
    ...
    voice: 'Kore',
    tone: 'Pragmatic',
    tools: [updateTodoListTool, executeCodeTool, githubActionTool]
  },
  maximus: {
    id: 'maximus',
    name: 'Maximus',
    ...
    voice: 'Charon',
    tone: 'Analytical',
    tools: [updateTodoListTool, searchWebTool, createTicketTool]
  },
  orbit: {
    id: 'orbit',
    name: 'Orbit',
  ...
  master: {
    ...
    voice: 'Zephyr',
    tone: 'Diplomatic',
    tools: [updateTodoListTool, sendEmailTool, createTicketTool]
  },
  atlas: {
    id: 'atlas',
    name: 'Atlas',
  ...
  forge: {
    ...
    voice: 'Kore',
    tone: 'Energetic',
    tools: [updateTodoListTool, executeCodeTool, createTicketTool]
  },
  nova: {
    id: 'nova',
    name: 'Nova',
    ...
    voice: 'Kore',
    tone: 'Passionate',
    tools: [updateTodoListTool, executeCodeTool, analyzeDataTool]
  },
  nexus: {
    id: 'nexus',
    name: 'Nexus',
    ...
    voice: 'Zephyr',
    tone: 'Precise',
    tools: [updateTodoListTool, executeCodeTool, searchWebTool]
  }
};
